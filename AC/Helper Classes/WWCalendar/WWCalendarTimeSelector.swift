...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = Color.AppColorCode.color()
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = Color.AppColorCode.color()
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = Color.AppColorCode.color()
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    open var optionCalendarUnderlinedBackgroundColor = Color.AppColorCode.color()
    ...
    open var optionClockBackgroundColorAMPMHighlight = Color.AppColorCode.color()
    ...
    open var optionClockBackgroundColorHourHighlight = Color.AppColorCode.color()
    open var optionClockBackgroundColorHourHighlightNeedle = Color.AppColorCode.color()
    ...
    open var optionClockBackgroundColorMinuteHighlight = Color.AppColorCode.color()
    open var optionClockBackgroundColorMinuteHighlightNeedle = Color.AppColorCode.color()
    ...
    open var optionButtonFontColorCancel = Color.AppColorCode.color()
    open var optionButtonFontColorDone = Color.AppColorCode.color()
    open var optionButtonFontColorCancelHighlight = Color.AppColorCode.color().withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = Color.AppColorCode.color().withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor = Color.AppColorCode.color()
    ...
    open var optionSelectorPanelBackgroundColor = Color.AppColorCode.color().withAlphaComponent(0.9)
    ...
    fileprivate var tintColor : UIColor! = Color.AppColorCode.color()
...
internal class WWCalendarRow: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if detail.type == .month {
            ...
            let str = NSAttributedString(string: monthName, attributes: [NSAttributedString.Key.font: monthFont as Any, NSAttributedString.Key.foregroundColor: monthFontColor as Any, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            for (index, element) in days.enumerated() {
                let str = NSAttributedString(string: element, attributes: [NSAttributedString.Key.font: dayFont as Any, NSAttributedString.Key.foregroundColor: dayFontColor as Any,  NSAttributedString.Key.paragraphStyle: paragraph])
                ...
                if date.weekday == i {
                    ...
                    if comparisonDates.contains(date) {
                        ...
                        if multipleSelectionEnabled {
                            var testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: dateTodayFontHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                            ...
                            if dateFutureFontHighlight.lineHeight > dateTodayFontHighlight.lineHeight {
                                testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: dateFutureFontHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                            ...
                            if datePastFontHighlight.lineHeight > dateFutureFontHighlight.lineHeight {
                                testStringSize = NSAttributedString(string: "00", attributes: [NSAttributedString.Key.font: datePastFontHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph]).size()
                                dateMaxWidth = testStringSize.width
                                dateMaxHeight = testStringSize.height
                            }
...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if time.hour < 12 {
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight as Any, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPM as Any, NSAttributedString.Key.foregroundColor: fontColorAMPM as Any, NSAttributedString.Key.paragraphStyle: paragraph])
            ...
            var str = NSAttributedString(string: "AM", attributes: [NSAttributedString.Key.font: fontAMPM as Any, NSAttributedString.Key.foregroundColor: fontColorAMPM as Any, NSAttributedString.Key.paragraphStyle: paragraph])
            var ampmHeight = fontAMPM.lineHeight
            str.draw(in: CGRect(x: amX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
            str = NSAttributedString(string: "PM", attributes: [NSAttributedString.Key.font: fontAMPMHighlight as Any, NSAttributedString.Key.foregroundColor: fontColorAMPMHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph])
            ampmHeight = fontAMPMHighlight.lineHeight
            str.draw(in: CGRect(x: pmX, y: ampmY + (ampmSize - ampmHeight) / 2, width: ampmSize, height: ampmHeight))
        }
        
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHour as Any, NSAttributedString.Key.foregroundColor: fontColorHour as Any, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontHourHighlight as Any, NSAttributedString.Key.foregroundColor: fontColorHourHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph]
            ...
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontMinute as Any, NSAttributedString.Key.foregroundColor: fontColorMinute as Any, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: fontMinuteHighlight as Any, NSAttributedString.Key.foregroundColor: fontColorMinuteHighlight as Any, NSAttributedString.Key.paragraphStyle: paragraph]
