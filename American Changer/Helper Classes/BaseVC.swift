...
extension BaseVC: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        AppPrefsManager.sharedInstance.setCurrentLat(obj: String(locValue.latitude) as String)
        AppPrefsManager.sharedInstance.setCurrentLong(obj: String(locValue.longitude) as String)
    }
